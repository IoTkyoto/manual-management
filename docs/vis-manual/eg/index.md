...
![How to connect to the dynamoDB console](../../images/vis-manual/ja/access_to_dynamo.png)

### 2. Check the region

-   If you have no reason to choose another region, select the closest region.

![Check the region](../../images/vis-manual/ja/check_region.png)

### 3. Select [Create table] in the DynamoDB console screen

![create table](../../images/vis-manual/ja/select_create_table.png)

### 4. Enter any name in the table name

![Determine table name](../../images/vis-manual/ja/setting_table_name.png)
...
-   Select "Character string" or "Numeric value" as the data type according to the value output by the IoT device.
    ![Set partition key](../../images/vis-manual/ja/setting_partitionkey.png)

### 6. Check the [Add sort key] checkbox

![Add sort key](../../images/vis-manual/ja/check_sortkey.png)
...
![Sort key setting](../../images/vis-manual/ja/setting_sortkey.png)
...
![IAM console selection](../../images/vis-manual/ja/open_iam.png)

### 2. Select and open [Users], click [Add User], and create a user with any name

![Add user](../../images/vis-manual/ja/select_add_user.png)

-   Check the box for [Programmatic access]
-   Select [Next Step]

![Create user](../../images/vis-manual/ja/create_user.png)
...
![Policy selection](../../images/vis-manual/ja/select_policy.png)
...
![New user confirmation](../../images/vis-manual/ja/verification_create_user.png)

![csv download](../../images/vis-manual/ja/download_csv.png)
...
![Policy creation screen](../../images/vis-manual/ja/select_create_policy.png)

### 3. Create a policy that grants read-only permissions for the specific DynamoDB table

-   Select DynamoDB from [Select Service]
    ![Service selection](../../images/vis-manual/ja/select_service.png)
-   Enter `getItem` in [Filter action] and check the checkbox of`GetItem`
    ![Select action (getItem)](../../images/vis-manual/ja/check_get_item.png)
-   Enter `query` in [Filter action] and check the checkbox of`Query`
    ![Select action (query)](../../images/vis-manual/ja/check_query.png)
-   Enter `describeTable` in [Filter action] and check the check box of`DescribeTable`
    ![Select Action (describeTable)](../../images/vis-manual/ja/check_describe_table.png)
-   Select Resources and select the Add ARN button
    ![Resource selection](../../images/vis-manual/ja/select_resource.png)
-   Fill in the required information and select the [Add] button
    ![Enter ARN](../../images/vis-manual/ja/input_arn.png)
-   Confirm your entry and select [Confirm Policy]
    ![Select Confirm Policy](/../../images/vis-manual/ja/setting_all_policy.png)
-   Enter any policy name and select [Create Policy]
    ![Policy creation completed](../../images/vis-manual/ja/complete_create_policy.png)
...
![Policy selection](../../images/vis-manual/ja/select_custom_policy.png)
...
![New user confirmation](../../images/vis-manual/ja/verification_create_custom_user.png)
...
![VIS login screen](../../images/vis-manual/ja/vis_login.png)
...
2. sign up：If you do not have an account, please create one from here
3. Forgot your password?：If you forget your account password, please reissue your password here.

### 1. Create an account

#### 1.1. Select the [Sign up] button to display the new registration screen

![VIS new registration screen](../../images/vis-manual/ja/create_account.png)

#### 1.2. Enter your email address, ID and password

If the ID is the same as the email address and there is no problem, check the "Use the same email address as the ID" checkbox.
...
![Authentication code transmission screen](../../images/vis-manual/ja/send_code.png)
...
Select the [Set password] button to complete the password reset.

![Password reset](../../images/vis-manual/ja/reset_password.png)

## [Step 4] Visualize on graph screen<a name="step4"></a>

![Graph screen menu](../../images/vis-manual/ja/vis_menu.png)
...
6. Graph sort: If there are multiple graphs, sort the graphs.
7. Graph display method switching: You can arrange the graphs in two columns or one column.
...
![Graph setting selection](../../images/vis-manual/ja/select_graph_setting.png)

-   Open the [Thresholds] tab from the setting screen

![Threshold setting selection](../../images/vis-manual/ja/select_alert_setting.png)
...
![Threshold setting](../../images/vis-manual/ja/setting_alert.png)
...
![Alert mail example](../../images/vis-manual/ja/alert_mail.png)
...
![Search screen selection](../../images/vis-manual/ja/select_search.png)
...
![Enter search items](../../images/vis-manual/ja/input_search_conditions.png)

### 3. Get the graph

-   You can get the data and display the graph by selecting the [Search] button.

![search results](../../images/vis-manual/ja/search_result.png)
...
![csv download selection](../../images/vis-manual/ja/select_csv_download.png)
...
![csv download condition entry](../../images/vis-manual/ja/input_csv_download_conditions.png)

### 3. get csv file

-   You can get the csv file of the data of the specified condition by selecting the [Download] button

![csv download result](../../images/vis-manual/ja/csv_download_result.png)
...
![Sort mode switching selection](../../images/vis-manual/ja/select_move_graph.png)
...
![Graph move](../../images/vis-manual/ja/drag_graph.png)
...
![End sort](../../images/vis-manual/ja/quit_move_graph.png)
...
![Graph delete selection](../../images/vis-manual/ja/select_remove_graph.png)
...
![Confirm graph deletion](../../images/vis-manual/ja/confirm_remove_graph.png)
